...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
        ...
        private float debugDetectDistance = 1.0f;
        ...
        {
            if (debugMoveDir != Vector3.zero)
            {
                Gizmos.color = Color.yellow;
                Vector3 start = transform.position + Vector3.up * 0.5f;

                // Draw the cast direction line
                Gizmos.DrawLine(start, start + debugMoveDir * debugDetectDistance);

                // Draw the "thickness" of the cast
                Gizmos.DrawWireSphere(start + debugMoveDir * debugDetectDistance, debugRadius);
